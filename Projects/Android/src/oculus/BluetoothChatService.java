...
public class BluetoothChatService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        if (mConnectThread != null) {
            Log.d(TAG, "Cancel the thread that completed the connection");
            mConnectThread.cancel();
            mConnectThread = null;
        }
        ...
        if (mSecureAcceptThread != null) {
            Log.d(TAG, "Cancel the accept thread because we only want to connect to one device");
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            Log.d(TAG, "begin connected(mmSocket, mmDevice, mSocketType)");
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            Log.e(TAG, "over mConnectedThread!!");
        }
